...
console.log(
  "Tipo del Objeto JSON con método stringify(): " +
...
console.log(
  "Tipo del Objeto JSON2 con método parse(): " + typeof JSON.parse(objetoJSON2)
); // El tipo del objeto es "object" Vuelve a ser un objeto de JavaScript
