...
console.log("\n============ For =============\n");
for (let i = 0; i < 10; i++) {
  // El bucle for se ejecuta 10 veces, desde i = 0 hasta que la condición sea falsa (i menor que 10) y incrementa i en 1 cada vez que se ejecuta.
...
for (fruta of frutas) {
  // Recorre el array de frutas con un bucle for in (Normalmente se describe el elemento como singuular y el array como plural)
