...
const procesoAsincrono = async () => {
  ...
  await new Promise((resolve, reject) => {
    // Las promesas se ejecutan asincronamente por lo tanto utilizamos await para esperar a que se ejecute la función. await remplaza el then y catch de manerá sincronica.
    setTimeout(() => {
